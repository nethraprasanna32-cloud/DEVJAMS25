...
# IMPORTANT: Customize this for the specific disaster and region you are monitoring.
SEARCH_QUERY = "(cyclone OR #CycloneAlert OR flood OR #FloodWarning) india -is:retweet lang:en"
